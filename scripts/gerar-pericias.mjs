 ...
 * perícia (chave de tradução, atributo-chave, "somente treinada", penalidade de
 * armadura). A ficha exportada precisa disso: escrever só `{treinado:true}` num
 * `system.pericias.<code>` apaga o resto do SkillData e a perícia aparece sem
 * nome e com atributo Força na ficha importada.
 *
